    ...
    return (
        <main className="min-h-screen pt-32 pb-20 bg-transparent">
            <div className="container-padding max-w-4xl mx-auto">
                ...
                {/* Dashboard / Internal Mockup Showcase */}
                {project.dashboardImage && (
                    <div className="mb-20 relative group perspective">
                        <div className="absolute -inset-1 bg-gradient-to-r from-primary via-accent to-primary rounded-3xl blur-2xl opacity-20 group-hover:opacity-40 transition duration-1000"></div>
                        <div className="relative bg-[#0A0A0A] rounded-2xl border border-white/10 shadow-2xl overflow-hidden transform transition-all duration-700 hover:scale-[1.01]">
                            {/* Browser Header */}
                            <div className="h-10 border-b border-white/10 bg-white/5 flex items-center px-4 gap-2 backdrop-blur-md">
                                ...
                                <div className="mx-auto bg-black/40 border border-white/5 rounded-md px-4 py-1 text-xs text-slate-400 font-mono tracking-wider flex items-center gap-2">
                            ...
                            {/* Image Container */}
                            <div className="relative w-full aspect-[16/9] bg-black/50">
                                <Image
                                    src={project.dashboardImage}
                                    alt="Internal Dashboard View"
                                    fill
                                    className="object-cover object-top"
                                />
                            </div>
                        </div>
                        <p className="text-center mt-6 text-sm text-slate-500 font-mono tracking-widest uppercase">
                            Exclusive Look: Internal Dashboard
                        </p>
                    </div>
                )}
